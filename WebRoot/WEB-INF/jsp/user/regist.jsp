...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/js/jquery/jquery-1.5.1.js'/>"></script>
...
<div class="divBody">
  ...
  <div class="divCenter">
    <form action="<c:url value='../regist/dologin.do'/>" method="post" onsubmit="javascript:return registForm();">
    <table>
      <tr>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>
          <span class="verifyCodeImg"><img id="vCode" width="240" src='<c:url value="../regist/verfiycode.do"/>' /></span>
        </td>
        <td><a href="javascript: changeVelidateCode();">换一张</a></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>
